package com.wangxingxing.mycomposeapp.aop.click
...
class SingleClickAspect {
     ...
     * 方法切入点
     */
    @Pointcut("execution(@com.wangxingxing.mycomposeapp.aop.click * *(..))")
    fun method() {}
    ...
    fun aroundJoinPoint(joinPoint: ProceedingJoinPoint, singleClick: SingleClick) {
        ...
        if (currentTimeMillis - lastTime < singleClick.value && (tag == lastTag)) {
            LogUtils.i("SingleClick: ${singleClick.value} 毫秒内发生快速点击 $tag")
            return
        }
